...
| QQ-ChatGPT-Robot-02 | [QChatGPT](https://github.com/RockChinQ/QChatGPT) | 2.2k | 😎简单易用、🧩丰富生态 - 大模型原生即时通信机器人平台 | 适配 QQ / 微信（企业微信、个人微信）/ 飞书 / 钉钉 / Discord / Telegram / Slack 等平台 |
...
| Error detection-02 | [stackexplain](https://github.com/shobrook/stackexplain) | 455 | Terminal assistant for the hopelessly confused | Run the pythohn script with the stackexplain command and automatically detect errors to give the correct fix |
